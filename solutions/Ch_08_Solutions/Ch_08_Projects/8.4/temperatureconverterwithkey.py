...
class TemperatureConverter(EasyFrame):
    ...
    def __init__(self):
        ...
        # Enable event handlers for return key in fields
        self.celsiusField.bind("<Return>",
                               lambda event: self.computeFahr())
        self.fahrField.bind("<Return>",
                            lambda event: self.computeCelsius())
